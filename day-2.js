...
walletNumber = Number(wallet);
  ...
  // 3. use a math expression with the > operator to say if the statements is true or false.
messageParagraph.innerHTML = `The TV costs ${tvNumber}. You have ${walletNumber} in your bank. You can afford the TV: ${walletNumber > tvNumber}`
...
bankNumber = Number(bank);
  ...
  // 3. use a math expression with the > operator to say if the statements is true or false.
`You have ${rocketNumber}. You have ${bankNumber} in your bank account. You can afford the rocket: ${bankNumber > rocketNumber}`
